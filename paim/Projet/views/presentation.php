...
<body>
            ...
            <ul class="concept-list">
                ...
                <li>🗓️ Profitez d’un planning détaillé pour chaque voyage
                    ...
                    if ($voyages === null) {
                        ...
                        echo "</div>";
                        echo "<a href='voyage_détails.php?id=" . $voyages[0]['id'] . "' class='planning-link' id='details-link'>En savoir plus</a>";
                        echo "</div>";
                    }
                    ?>
                </li>
    ...
    <script>
        function updatePlanning(index) {
            ...
            `;
            document.getElementById('details-link').href = `voyage_détails.php?id=${voyage.id}`;
        }
