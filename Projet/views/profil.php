            ...
            <?php if (!empty($user_voyages)): ?>
                        ...
                        ?>
                            <div class="profile-result-item">
                                ...
                                <div class="profile-result-details">
                                    ...
                                    <p><span>💳 Statut :</span> <?php echo is_array($voyage_data) && isset($voyage_data['statut_paiement']) ? htmlspecialchars($voyage_data['statut_paiement']) : 'En attente'; ?></p>
                ...
                <div class="finalize-action">
                    <form action="../scripts/cybank_payment.php" method="POST">
                        ...
                        $_SESSION['last_montant'] = calculateTotalAmount($user_voyages, $voyages);
